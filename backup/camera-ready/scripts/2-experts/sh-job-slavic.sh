...
PY_SCRIPT="scripts/2-experts/8.1 additional_encoder_baselines.py"
...
echo "Starting Slavic-specific additional comparison baselines at $(date)"
echo "GPU_IDS=${GPU_IDS}"
echo "Output root: ${OUTPUT_ROOT}"
echo "Slovenian model: ${MODEL_ROOT}/EMBEDDIA_sloberta"
echo "Serbian model: ${MODEL_ROOT}/classla_bcms-bertic"
...
echo "Slavic-specific additional comparison baselines finished at $(date)"
exit "$status"
