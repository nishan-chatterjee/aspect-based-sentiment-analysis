...
|---|---|---|---:|
| hbs | masked | Available | 0.9236 |
| hbs | unmasked | Available | 0.9237 |
| slovenian | masked | Available | 0.8350 |
| slovenian | unmasked | Available | 0.8251 |
...
snapshot_download(
    repo_id="nishan-chatterjee/aspectbench-longformer",
    local_dir=ROOT / "models" / "longformer",
)
```
